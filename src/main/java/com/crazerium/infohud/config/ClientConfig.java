...
public final class ClientConfig {
    ...
    static {
        ...
        SCALE = builder.defineInRange("scale", 1.0D, 0.5D, 3.0D);
        SHOW_ICONS = builder.define("show_icons", true);
        TEXT_SHADOW = builder.define("text_shadow", true);

        builder.pop();
        builder.push("lines");

        SHOW_PLAYER_FPS = builder.define("show_player_fps", true);
        SHOW_PING = builder.define("show_ping", true);
        SHOW_MEMORY = builder.define("show_memory", true);
        SHOW_POSITION = builder.define("show_position", true);
        SHOW_FACING = builder.define("show_facing", true);
        SHOW_DIMENSION = builder.define("show_dimension", true);
        SHOW_BIOME = builder.define("show_biome", true);
        SHOW_LIGHT = builder.define("show_light", true);
        SHOW_WORLD_TIME = builder.define("show_world_time", true);
        SHOW_SESSION = builder.define("show_session", true);
